  ...
  return (
    ...
    >
      ...
      <div className="relative h-[70vh] bg-cover bg-center bg-no-repeat flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-primaryDark/80 via-primary/75 to-primaryDark/80"></div>
        </div>
        <div className="relative flex flex-col items-center justify-center text-center px-4 z-10">
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-white/90 max-w-3xl mx-auto drop-shadow-md"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-center mb-12">
            <div className="text-left">
              ...
              <p className="text-lg text-textSecondary font-inter leading-relaxed">
            ...
            <div className="rounded-base overflow-hidden shadow-lg bg-muted">
              <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <motion.div
            ...
            transition={{ duration: 0.8, delay: 0.2 }}
            className="bg-surface shadow-md rounded-base p-8 hover:shadow-lg transition-shadow"
          >
            <div className="flex items-center mb-4">
              <div className="p-3 bg-accent/10 rounded-base mr-4">
                <Target className="w-8 h-8 text-accent" />
              </div>
              <h3 className="text-2xl font-display font-bold text-textMain">Our Mission</h3>
            </div>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-display font-bold text-textMain">Our Values</h3>
            </div>
            <ul className="space-y-3 text-textSecondary font-inter">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl sm:text-4xl font-display font-bold text-textMain mb-8 text-center">
            What We Offer
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-surface rounded-base shadow-md overflow-hidden hover:shadow-lg transition-all duration-300"
              >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-accent/10 to-accent/20 rounded-lg p-8 md:p-12"
        >
          <h2 className="text-3xl sm:text-4xl font-display font-bold text-textMain mb-8 text-center">
            Why Choose Aptify?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-surface rounded-base p-6 text-center hover:shadow-md transition-shadow"
              >
                <div className="text-accent mb-4 flex justify-center">{feature.icon}</div>
                <h3 className="text-lg font-display font-bold text-textMain mb-2">
                  {feature.title}
                </h3>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to="/properties"
                  className="inline-block bg-surface text-accent px-8 py-3 rounded-base font-inter font-semibold hover:bg-accent/10 transition-colors"
                >
                  Browse Properties
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link
                  to="/contact"
                  className="inline-block bg-transparent border-2 border-white text-white px-8 py-3 rounded-base font-inter font-semibold hover:bg-surface hover:text-primary transition-colors"
                >
                  Contact Us
                </Link>
              </motion.div>
