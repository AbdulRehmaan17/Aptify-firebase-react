...
import { Home, Building2, Wrench, Hammer, Users, Award, Heart, Target, CheckCircle } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
                        <div className="text-left">
                            <p className="text-lg text-gray-700 font-inter mb-4 leading-relaxed">
                                Aptify was founded with a vision to revolutionize the real estate experience in Pakistan. We recognized that finding the perfect property, managing renovations, and coordinating construction projects shouldn't be complicated or stressful.
                            </p>
                            <p className="text-lg text-gray-700 font-inter mb-4 leading-relaxed">
                                Our platform brings together property buyers, sellers, renters, renovation experts, and construction professionals in one seamless ecosystem. We believe everyone deserves access to quality properties and professional services.
                            </p>
                            <p className="text-lg text-gray-700 font-inter leading-relaxed">
                                Today, Aptify has become a trusted name in Pakistan's real estate market, helping thousands of people find their dream homes and transform their properties with confidence.
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    ...
                    >
                        ...
                        <p className="text-gray-700 font-inter leading-relaxed">
                            To empower individuals and families in Pakistan to find their perfect property and transform their spaces with confidence. We're committed to making real estate transactions, renovations, and construction projects accessible, transparent, and stress-free for everyone.
                        </p>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, x: 20 }}
                    ...
                    >
                        ...
                        <ul className="space-y-3 text-gray-700 font-inter">
                            <li className="flex items-start">
                                ...
                                <span><strong>Integrity:</strong> Honest, transparent dealings in every transaction</span>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle className="w-5 h-5 text-yellow-600 mr-2 mt-0.5 flex-shrink-0" />
                                <span><strong>Excellence:</strong> Quality service and professional standards</span>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle className="w-5 h-5 text-yellow-600 mr-2 mt-0.5 flex-shrink-0" />
                                <span><strong>Innovation:</strong> Leveraging technology to improve experiences</span>
                            </li>
                        </ul>
                    </motion.div>
                </div>
                        ...
                        {[
                            {
                                ...
                                description: 'Browse thousands of properties for sale and rent. Find your perfect home with detailed listings, photos, and virtual tours.',
                            ...
                            },
                            {
                                ...
                                description: 'Connect with verified renovation experts. Transform your property with professional renovation and remodeling services.',
                            ...
                            },
                            {
                                ...
                                description: 'Build your dream property from the ground up. Work with experienced construction professionals for new builds and extensions.',
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: <Users className="w-8 h-8" />, title: 'Verified Professionals', desc: 'All service providers are verified and experienced' },
                            { icon: <Award className="w-8 h-8" />, title: 'Quality Assurance', desc: 'We maintain high standards for all listings and services' },
                            { icon: <Building2 className="w-8 h-8" />, title: 'Wide Selection', desc: 'Thousands of properties and service providers to choose from' },
                            { icon: <CheckCircle className="w-8 h-8" />, title: 'Easy Process', desc: 'Streamlined platform for seamless transactions' }
                        ].map((feature, index) => (
                            <motion.div
                                key={index}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto">
                            Join thousands of satisfied customers who have found their perfect home or transformed their property with Aptify.
                        </p>
