...
/**
 * ConstructorDashboard Component
 * Main dashboard for construction service providers
 * Displays overview, statistics, and quick actions
 * Uses real-time Firestore listeners for constructionProjects
 */
const ConstructorDashboard = () => {
  ...
  // Fetch construction projects with real-time listener
  useEffect(() => {
            ...
            fallbackUnsubscribeRef.current = onSnapshot(
              ...
              (fallbackError) => {
                ...
                if (fallbackError.code === 'permission-denied') {
                  ...
                  toast.error('Failed to load construction projects.');
                }
              }
            );
          } else {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-textMain mb-2">Constructor Dashboard</h1>
          <p className="text-textSecondary">Welcome back! Here's an overview of your construction projects.</p>
        </div>
        ...
        <div className="bg-surface rounded-lg border border-borderColor p-6 shadow-sm">
          ...
          {projects.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-semibold text-textMain mb-2">No Construction Projects Yet</h3>
              <p className="text-textSecondary mb-6">
                You haven't been assigned any construction projects yet. Check back later or contact support.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {recentProjects.map((project) => (
                <div
                  ...
                  onClick={() => navigate(`/constructor/projects/${project.id}`)}
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h3 className="text-lg font-semibold text-textMain">
                          {project.projectType || project.serviceCategory || 'Construction Project'}
                        </h3>
        ...
        {projects.length > 0 && (
          <div className="mt-8 bg-surface rounded-lg border border-borderColor p-6 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={() => navigate('/constructor/projects')} variant="primary">
                View All Projects
              </Button>
              <Button onClick={() => navigate('/constructor/profile')} variant="outline">
                Update Profile
              </Button>
            </div>
          </div>
