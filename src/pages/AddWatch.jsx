...
const AddWatchForm = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      formData.append('upload_preset', 'images_watches'); // Set in Cloudinary
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to save watch.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex space-x-4">
            <Button
              ...
              disabled={loading}
            >
              {loading ? 'Saving...' : id ? 'Update Watch' : 'Add Watch'}
            </Button>
            <Button
              type="button"
