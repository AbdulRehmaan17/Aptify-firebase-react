...
const RenovationList = () => {
  ...
  useEffect(() => {
    ...
    // SIMPLE QUERY: Fetch all renovators, then filter/sort client-side
    ...
    const unsubscribe = onSnapshot(
      ...
      (error) => {
        ...
        setError('Failed to load renovation providers');
        setProviders([]);
        setLoading(false);
      }
    );
   ...
   * Navigates to renovation request form with providerId as query parameter
              ...
              <div className="p-6">
                ...
                {provider.bio && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-textSecondary leading-relaxed line-clamp-3 break-words">{provider.bio}</p>
                  </div>
                )}
